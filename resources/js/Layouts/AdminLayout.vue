        ...
        <div class="">
            ...
            <nav class="bg-white ">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
                    <div class="flex justify-between h-16 hidden">
                        <div class="flex">
                            <!-- Logo -->
            ...
            <a-layout class="background " style="min-height: 100vh"> 
                <div class="side-bar " >
                    ...
                    <a-menu  :inline-collapsed="collapsed" class="pr-1 md:p-2 !shadow">
                            ...
                            <a-menu-item key="admin.consultations.answer.peer" >
                                ...
                                <NavLink :href="route('admin.consultations.answer', 'peer')" :active="route().current('admin.consultations.answer')"  class="!text-lg !p-0 ">
                                    同伴影响
                                </NavLink>
                            </a-menu-item>
                            <a-menu-item key="admin.consultations.answer.study" >
                                <template #icon>
                                    <div class="icon">
                                ...
                                <NavLink :href="route('admin.consultations.answer', 'study')" :active="route().current('admin.consultations.answer')"  class="!text-lg !p-0 ">
                                    学业压力
                                </NavLink>
                            </a-menu-item>
                            <a-menu-item key="admin.consultations.answer.interpersonal" >
                                <template #icon>
                                    <div class="icon">
                                ...
                                <NavLink :href="route('admin.consultations.answer', 'interpersonal')" :active="route().current('admin.consultations.answer')"  class="!text-lg !p-0 ">
                                    人际关系
                                </NavLink>
                            </a-menu-item>
                            <a-menu-item key="admin.consultations.answer.sleep" >
                                <template #icon>
                                    <div class="icon">
                                ...
                                <NavLink :href="route('admin.consultations.answer', 'sleep')" :active="route().current('admin.consultations.answer')"  class="!text-lg !p-0 ">
                                    睡眠
                                </NavLink>
                            </a-menu-item>
                            ...
                            <template v-if="$page.props.user.roles.includes('admin')">
                                ...
                                <a-menu-item key="admin.consultations.index">
                                    ...
                                    <NavLink :href="route('admin.consultations.index')" :active="route().current('admin.consultations.index')" class="!text-lg !p-0 ">
                                        压力感知
                                    </NavLink>
                                </a-menu-item>
                                <!--  -->
                                <a-menu-item key="admin.consultations.create" >
                                    <template #icon>
                                        <HomeOutlined  class="!text-2xl " />
                                    </template>
                                    <NavLink :href="route('admin.consultations.create')" :active="route().current('admin.consultations.create')" class="!text-xl !p-0 ">
                                        选项
                                    </NavLink>
                                </a-menu-item>
                                <a-menu-item key="admin.consultations.index">
                                    ...
                                    <NavLink :href="route('admin.consultations.view_answer')" :active="route().current('admin.consultations.view_answer')" class="!text-lg !p-0 ">
                                        结果
                                    </NavLink>
                                </a-menu-item>
                                <!--  -->
                                ...
                                <a-menu-item key="admin.mediates.index">
                                    ...
                                    <NavLink :href="route('admin.mediates.index')" :active="route().current('admin.mediates.index')" class="!text-lg !p-0 ">
                                        情绪调解
                                    </NavLink>
                                </a-menu-item>
                                ...
                                <a-menu-item key="admin.mediates.create" >
                                    ...
                                    <NavLink :href="route('admin.mediates.create')" :active="route().current('admin.mediates.create')" class="!text-xl !p-0 ">
                                        选项
                                    </NavLink>
                                </a-menu-item>
                                <a-menu-item key="admin.mediates.index">
                                    ...
                                    <NavLink :href="route('admin.mediates.view_answer')" :active="route().current('admin.mediates.view_answer')" class="!text-lg !p-0 ">
                                        结果
                                    </NavLink>
                                </a-menu-item>
                                <!--  -->
                ...
                <div class="flex-1 w-full relative">    
                    ...
                    <header v-if="$slots.header" class="absolute banner shadow w-full flex items-center ">
                        ...
                        <div class="absolute left-4 text-xl " >
